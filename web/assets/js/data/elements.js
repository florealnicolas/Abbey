...
const schemeMap = {
    basicScheme: {
        steps: {
            malting: {
                name: "malting",
                input: {name: "wheat", amount: 10}
            },
            maltGrinding: {
                name: "malt grinding",
                input: {name: "malt", amount: 10}
            },
            mashing: {
                name: "mashing",
                input: [
            ...
            fermenting: {
                name: "fermenting",
                input: {name: "beerToFerment", amount: 10}
            },
            secondFiltering: {
                name: "second filtering",
                input: {name: "fermentedBeer", amount: 10}
            },
            ripening: {
                name: "ripening",
                input: {name: "beerToRipe", amount: 10}
            },
            thirdFiltering: {
                name: "third filtering",
                input: {name: "ripeBeer", amount: 10}
            }
